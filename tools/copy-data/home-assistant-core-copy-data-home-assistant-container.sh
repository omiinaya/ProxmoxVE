...
# bash -c "$(curl -fsSL https://raw.githubusercontent.com/omiinaya/ProxmoxVE/testingmain/tools/copy-data//home-assistant-core-copy-data-home-assistant-container.sh)"
