...
curl -fsSL "https://raw.githubusercontent.com/omiinaya/ProxmoxVE/refs/heads/frigate-fix/tools/addon/daemonsync_2.2.0.0059_amd64.deb" -o "daemonsync_2.2.0.0059_amd64.deb"
