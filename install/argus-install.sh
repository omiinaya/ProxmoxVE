...
service:
  ...
  omiinaya/ProxmoxVE:
    latest_version:
      type: github
      url: omiinaya/ProxmoxVE
      use_prerelease: false
    dashboard:
      icon: https://raw.githubusercontent.com/omiinaya/ProxmoxVE/refs/heads/main/misc/images/logo.png
      icon_link_to: https://helper-scripts.com/
      web_url: https://github.com/omiinaya/ProxmoxVE/releases
EOF
